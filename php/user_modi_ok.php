...
if($u_pw!="")
{
    ...
    $sql = "UPDATE account SET u_pw = '".$hashpw."', u_active = '".$u_active."', u_update = '".$u_update."', r_sel = '".$r_sel."', r_update = '".$r_update."' WHERE (u_num = '".$u_num."')";
    ...
    $sql = "UPDATE account SET u_active = '".$u_active."', u_update = '".$u_update."', r_sel = '".$r_sel."', r_update = '".$r_update."' WHERE (u_num = '".$u_num."')";
    if ($conn->query($sql) === TRUE) 
    {
    } 
    else {
